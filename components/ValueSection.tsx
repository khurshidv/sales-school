            ...
            <div className="max-w-3xl mx-auto text-center relative z-10">
              ...
              <div className="flex justify-center">
                <a
                    ...
                    className="group inline-flex items-center gap-3 rounded-full whitespace-nowrap text-white cursor-pointer transition-all duration-200 active:scale-[0.98] hover:scale-[1.03] px-8 py-5 text-base md:px-10 md:text-lg font-bold tracking-wide"
