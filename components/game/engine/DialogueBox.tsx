...
export default function DialogueBox({
  ...
  return (
    ...
    <motion.div
      ...
      className="absolute bottom-0 left-0 right-0 min-h-[14dvh] px-3 py-2 sm:min-h-[22dvh] sm:px-5 sm:py-4 lg:min-h-[26dvh] lg:px-6 lg:py-5 border-t border-white/10"
      style={{
