            ...
            {pains.map((key, i) => (
              <FadeUp key={key} delay={i * 80}>
                <div className="flex gap-4 items-start p-5 rounded-xl bg-surface-container-low hover:bg-surface-container transition-colors group">
                  <span className="material-symbols-outlined text-error mt-0.5 shrink-0 drop-shadow-[0_0_8px_#ba1a1acc] group-hover:drop-shadow-[0_0_14px_#ba1a1a] transition-all duration-300">close</span>
