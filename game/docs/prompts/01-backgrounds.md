# Промпты — Фоны (Backgrounds)
# Инструмент: Gemini Imagen (nanobanana pro)
# Размер: 1920×1080 landscape

---

## BG-01 | Шоурум — Основной (`bg_showroom`)

**Используется:** Day 1-5 (основной фон)
...
windows with city view, polished marble floors with reflections, 4-5 brand new
Chevrolet cars displayed under dramatic spotlights, contemporary minimalist
architecture, warm golden ambient lighting mixed with cool blue daylight,
sales consultant desk in background, Chevrolet logo on wall, cinematic
composition, semi-realistic illustration, Rockstar Games concept art quality,
no people, 16:9 landscape, highly detailed, 1920x1080
```

### Негативный промпт:
```
anime, cartoon, 3D render, photograph, blurry, dark, messy, outdated interior,
people, text
```

---

## BG-02 | Вход в салон (`bg_showroom_entrance`)

**Используется:** Day 1, 3, 5 (клиент входит)

### Промпт:
```
GTA V loading screen environment art, exterior entrance of a modern Chevrolet
dealership in Tashkent, large glass automatic doors with Chevrolet gold logo,
clean modern facade, potted plants at entrance, afternoon sunlight casting
long shadows, parking lot visible through glass with Chevrolet cars, warm
golden sunlight streaming through entrance, dramatic perspective from inside
looking toward door, semi-realistic illustration, Rockstar Games art style,
cinematic quality, 16:9, 1920x1080, no people
```

### Негативный промпт:
```
anime, cartoon, 3D render, photograph, blurry, dark, night, text, watermark
```

---

## BG-03 | Офис менеджера (`bg_manager_office`)

**Используется:** Day 1, 2 (briefing Рустама)

### Промпт:
```
GTA V loading screen art style, cozy manager office in a Chevrolet dealership,
wooden desk with laptop and papers, framed sales achievement certificates on
wall, Chevrolet promotional posters, warm desk lamp lighting, glass window
showing the showroom floor below, leather executive chair, family photo on desk,
plants, bookshelves with sales training books, warm amber lighting, dramatic
shadows, semi-realistic illustration, Rockstar Games concept art quality,
no people, 16:9, 1920x1080, highly detailed
```

### Негативный промпт:
```
anime, cartoon, 3D render, blurry, cold lighting, modern minimal, people, text
```

---

## BG-04 | VIP Зона (`bg_vip_lounge`)

**Используется:** Day 4 (Абдуллаев)

### Промпт:
```
GTA V loading screen environment art, exclusive VIP client lounge inside a
luxury car dealership, dark walnut wood paneling, deep burgundy leather sofas,
crystal glasses and tea service on low table, Tahoe SUV displayed on private
platform with spotlights, abstract gold-toned art on walls, dramatic low
lighting with warm amber accent lights, luxurious carpet, subtle Chevrolet
emblem in gold, atmosphere of exclusivity and wealth, semi-realistic
illustration, Rockstar Games art style, no people, 16:9, 1920x1080,
cinematic quality
```

### Негативный промпт:
```
anime, cartoon, 3D render, bright daylight, cheap, modern minimal, people, text
```

---

## BG-05 | Парковка (`bg_parking`)

**Используется:** Day 3, 5

### Промпт:
```
GTA V loading screen environment art, exterior parking lot of a Chevrolet
dealership in Tashkent on a bright sunny day, row of brand new Chevrolet cars
(Tracker, Equinox, Malibu) parked neatly with price tags, modern dealership
building facade in background, clear blue Central Asian sky, palm trees and
decorative plants, warm afternoon sunlight with long shadows, fresh asphalt,
cinematic wide establishing shot, semi-realistic illustration, Rockstar Games
art style, no people, 16:9, 1920x1080, highly detailed
```
